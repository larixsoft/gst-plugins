...
namespace Xml {
	...
	public class ParserCtxt {
		...
		public Doc* read_memory (uint8[] buffer, string url, string? encoding = null, int options = 0);
	...
	public delegate int InputReadCallback (void* context, uint8[] buffer);
...
namespace Html {
	...
	public class Doc : Xml.Doc {
		...
		public static Doc* read_memory (uint8[] data, string url, string? encoding = null, int options = 0);
