...
namespace GLib {
	...
	public abstract class InputStream : GLib.Object {
		...
		public bool has_pending ();
		public bool is_closed ();
		public ssize_t read_map_info (Gst.MapInfo info, ssize_t streamread, uint cachesize, GLib.Cancellable? cancellable = null) throws GLib.IOError;
		...
		[CCode (cname = "g_input_stream_read")]
		public ssize_t read2 (void* buffer, size_t count, GLib.Cancellable? cancellable = null) throws GLib.IOError;
